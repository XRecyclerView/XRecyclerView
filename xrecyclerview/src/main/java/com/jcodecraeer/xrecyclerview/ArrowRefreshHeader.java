...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private boolean  mIsVertical; // 是否是竖直拉动刷新
    ...
    private void initView() {
        LogUtil.e("initView: CanScrollVertically " + mIsVertical);
        ...
        if (mIsVertical) {
            ...
            mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.listview_header_h, null);
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                if (mIsVertical) {
                    ...
                    mStatusTextView.setText(R.string.listview_header_hint_normal_h);
                }
                break;
    ...
    public void onMove(float delta) {
        if (mIsVertical) {
            if(getVisibleHeight() > 0 || delta > 0) {
                ...
                LogUtil.e("onMove: delta " + delta + " height " + getVisibleHeight() + " visibleHeight " + (delta + getVisibleHeight()));
            ...
            if(getVisibleWidth() > 0 || delta > 0) {
                LogUtil.e("onMove: delta " + delta + " width " + getVisibleWidth() + " visibleWidth " + (delta + getVisibleWidth()));
    ...
    private void smoothScrollTo(int destHeight) {
        if (mIsVertical) {
            ...
            ValueAnimator animator = ValueAnimator.ofInt(getVisibleWidth(), destHeight);
            animator.setDuration(300).start();
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation)
